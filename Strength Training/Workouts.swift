...
private let workoutsByMuscleGroup: [String: [String]] = [
    ...
    "Abs": ["Mountain Climbers", "Elbow Plank with Toe Taps", "Right Side Plank", "Left Side Plank", "Lower Ab Crunches", "Bicycle Crunches", "Ukrainian Twists", "High Boat to Low Boat"]
]
