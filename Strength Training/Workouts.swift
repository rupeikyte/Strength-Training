...
private let workoutsByMuscleGroup: [String: [Workout]] = [
    ...
    "Chest": [
        ...
        Workout(name: "DB Bench Press", muscleGroup: "Chest", description: "Compound chest press with dumbbells"),
        ...
        Workout(name: "Bodyweight Dips", muscleGroup: "Chest", description: "Compound excercise, lower chest emphasis"),
        Workout(name: "DB Flys", muscleGroup: "Chest", description: "Compound excercise using dumbbells"),
    ...
    "Shoulder": [
        ...
        Workout(name: "Shoulder Press DB", muscleGroup: "Shoulder", description: "Compound shoulder excercise"),
